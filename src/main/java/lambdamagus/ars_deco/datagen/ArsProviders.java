package lambdamagus.ars_deco.datagen;

import lambdamagus.ars_deco.ArsNouveauRegistry;
...
import static lambdamagus.ars_deco.datagen.Setup.provider;
import static com.hollingsworth.arsnouveau.setup.registry.RegistryHelper.getRegistryName;

public class ArsProviders {

    static String root = ArsDeco.MODID;
    ...
    public static class ImbuementProvider extends ImbuementRecipeProvider {
        ...
        public void collectJsons(CachedOutput cache) {
            ...
            /*
            recipes.add(new ImbuementRecipe("ars_deco_focus", Ingredient.of(Items.AMETHYST_SHARD), new ItemStack(ItemsRegistry.SUMMONING_FOCUS, 1), 5000)
    ...
    public static class PatchouliProvider extends com.hollingsworth.arsnouveau.common.datagen.PatchouliProvider {
        ...
        public void collectJsons(CachedOutput cache) {
            ...
            // Check the superclass for default pages.
        ...
        @Override
        public @NotNull String getName() {
            return "Ars Deco Patchouli Datagen";
        }

        @Override
        public Path getPath(ResourceLocation category, String fileName) {
            return this.generator.getPackOutput().getOutputFolder().resolve("data/" + root + "/patchouli_books/ars_deco/en_us/entries/" + category.getPath() + "/" + fileName + ".json");
        }
